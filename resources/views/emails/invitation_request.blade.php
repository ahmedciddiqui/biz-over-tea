...
<body>
    <div class="email-container">
        ...
        <div class="card-box">
            ...
            <h2>New Invitation Request - Business over tea</h2>
            ...
            <p><span class="label">Role:</span> {{ $data["role"] }}</p>
            <p><span class="label">Industry:</span> {{ $data["industry"] }}</p>
            <p><span class="label">Note:</span> {{ $data["note"] }}</p>


            <hr style="margin: 30px 0; border: none; border-top: 1px solid #ddd;">

            <p>This message was submitted through the Business over tea website invitation request form.</p>
        </div>
    </div>
</body>
